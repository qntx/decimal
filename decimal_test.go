...
func TestTrimTrailingZeros(t *testing.T) {
	testcases := []struct {
		...
		{false, bintFromBigInt(pow10[25].Big()), 19, "1000000", 0},
		{false, bintFromBigInt(pow10[24].Big()), 19, "100000", 0},
		{false, bintFromBigInt(pow10[15].Big()), 19, "0.0001", 4},
		{false, bintFromBigInt(pow10[1].Big()), 19, "0.000000000000000001", 18},
		{false, bintFromBigInt(pow10[2].Big()), 19, "0.00000000000000001", 17},
		{false, bintFromBigInt(pow10[3].Big()), 19, "0.0000000000000001", 16},
		{false, bintFromBigInt(pow10[4].Big()), 19, "0.000000000000001", 15},
		{true, bintFromBigInt(pow10[5].Big()), 19, "-0.00000000000001", 14},
		{true, bintFromBigInt(pow10[6].Big()), 19, "-0.0000000000001", 13},
		{true, bintFromBigInt(pow10[7].Big()), 19, "-0.000000000001", 12},
		{true, bintFromBigInt(pow10[8].Big()), 19, "-0.00000000001", 11},
		{true, bintFromBigInt(pow10[9].Big()), 19, "-0.0000000001", 10},
		{false, bintFromBigInt(pow10[10].Big()), 19, "0.000000001", 9},
		{false, bintFromBigInt(pow10[11].Big()), 19, "0.00000001", 8},
		{false, bintFromBigInt(pow10[12].Big()), 19, "0.0000001", 7},
		{false, bintFromBigInt(pow10[13].Big()), 19, "0.000001", 6},
		{false, bintFromBigInt(pow10[14].Big()), 19, "0.00001", 5},
		{false, bintFromBigInt(pow10[15].Big()), 19, "0.0001", 4},
		{false, bintFromBigInt(pow10[16].Big()), 19, "0.001", 3},
		{false, bintFromBigInt(pow10[17].Big()), 19, "0.01", 2},
		{false, bintFromBigInt(pow10[18].Big()), 19, "0.1", 1},
		{false, bintFromBigInt(pow10[19].Big()), 19, "1", 0},
		{false, bintFromBigInt(pow10[10].Big()), 1, "1000000000", 0},
		{false, bintFromBigInt(pow10[10].Big()), 2, "100000000", 0},
		{false, bintFromBigInt(pow10[10].Big()), 3, "10000000", 0},
		{false, bintFromBigInt(pow10[10].Big()), 4, "1000000", 0},
		{false, bintFromBigInt(pow10[10].Big()), 5, "100000", 0},
		{false, bintFromBigInt(pow10[10].Big()), 6, "10000", 0},
		{false, bintFromBigInt(pow10[10].Big()), 7, "1000", 0},
		{false, bintFromBigInt(pow10[10].Big()), 8, "100", 0},
		{false, bintFromBigInt(pow10[10].Big()), 9, "10", 0},
		{true, bintFromBigInt(pow10[10].Big()), 10, "-1", 0},
		{true, bintFromBigInt(pow10[10].Big()), 11, "-0.1", 1},
		{true, bintFromBigInt(pow10[10].Big()), 12, "-0.01", 2},
		{true, bintFromBigInt(pow10[10].Big()), 13, "-0.001", 3},
		{false, bintFromBigInt(pow10[10].Big()), 14, "0.0001", 4},
		{false, bintFromBigInt(pow10[10].Big()), 15, "0.00001", 5},
		{false, bintFromBigInt(pow10[10].Big()), 16, "0.000001", 6},
		{false, bintFromBigInt(pow10[10].Big()), 17, "0.0000001", 7},
		{false, bintFromBigInt(pow10[10].Big()), 18, "0.00000001", 8},
		{false, bintFromBigInt(pow10[10].Big()), 19, "0.000000001", 9},
	}
