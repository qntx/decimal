...
// SubAbs returns |u-v|.
func (u Uint128) SubAbs(v Uint128) Uint128 {
	if u.Gt(v) {
		return u.MustSub(v)
	}
	return v.MustSub(u)
...
// Div64 returns u/v.
func (u Uint128) Div64(v uint64) (Uint128, error) {
	q, _, err := u.QuoRem64(v)

	return q, err
}

// MustDiv64 returns u/v, panicking on overflow.
func (u Uint128) MustDiv64(v uint64) Uint128 {
	u, err := u.Div64(v)
	if err != nil {
		panic(err)
	}
...
func (u Uint128) QuoRem64(v uint64) (q Uint128, r uint64, err error) {
	if v == 0 {
...
// MustQuoRem64 returns q = u/v and r = u%v, panicking on overflow.
func (u Uint128) MustQuoRem64(v uint64) (q Uint128, r uint64) {
	q, r, err := u.QuoRem64(v)
	if err != nil {
		panic(err)
	}
...
// Mod64 returns r = u%v.
func (u Uint128) Mod64(v uint64) (r uint64, err error) {
	_, r, err = u.QuoRem64(v)

	return
}

// MustMod64 returns r = u%v, panicking on overflow.
func (u Uint128) MustMod64(v uint64) uint64 {
	r, err := u.Mod64(v)
	if err != nil {
		panic(err)
	}
...
func (u Uint128) String() string {
	...
	for i := len(buf); ; i -= 19 {
		q, r := u.MustQuoRem64(1e19) // largest power of 10 that fits in a uint64
